...
# Add routes to the app at "api"
MsgspecRouter.mount_routers(
    app,
    "/api",
    [
        items_router,
...
# or alternatively, without the prefix, one at a time
# items_router.register_routes(app)
# users_router.register_routes(app)
